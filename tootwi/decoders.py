# coding: utf-8
"""
Decoders parse API responses depending on what format is used. Usually APIs are
...
In addition to decoding, decoders provide extension to be added to URLs when
making a request. Extension must be an attribute of the decoder, even if the
decoder is a regular function (function can have attributes in Python). If no
